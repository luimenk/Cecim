...
function validaAgregar(){
    ...
    // formData.append('fraeatdata', new Blob([JSON.stringify(obj)], {
    //     type: "application/json"
    // }));
...
function vistaAgregar(valor){
    window.location = "/agregarFRAEAXE/" + valor;
}
...
function terminar(valor){
    window.location = "/terminarFRAEAXE/" + valor;
}
    ...
    $.getJSON("/FRAEAXE/getAllBy/"+id, function (result) {
        $.each(result, function (i, field) {
            ...
            tbl +=
                ...
                '<td class="text-center"><button class="btn btn-success" onclick="verImagen(' + field.idFRAEAXEDATA + ')"><i class="fa fa-picture-o"></i>Ver Imagen</button></td>' +
...
function cargarTabla() {
    ...
    $.getJSON("/FRAEAXE", function (result) {
        $.each(result, function (i, field) {
            ...
            tbl +=
                '<tr>' +
                '<td class="text-center">' + field.idFRAEAXE + '</td>' +
                ...
                '<td class="text-center"><button class="btn btn-info" onclick="verInfo(' + field.idFRAEAXE + ')"><i class="fa fa-eye"></i>Ver</button></td>';
            if (field.estatus === "inicio"){
                tbl +=
                ...
                tbl +=
                    '<td class="text-center"><button class="btn btn-success" disabled><i class="fa fa-flag"></i>Iniciar</button></td>' +
                    '<td class="text-center"><button class="btn btn-warning" onclick="vistaAgregar(' + field.idFRAEAXE + ')"><i class="fa fa-plus"></i>Agregar</button></td>' +
                    '<td class="text-center"><button class="btn btn-danger" onclick="terminar(' + field.idFRAEAXE + ')"><i class="fa fa-save"></i>Terminar</button></td>';
            }
        });
        tbl += '</tbody>';
        tbl += '<tfoot>' +
