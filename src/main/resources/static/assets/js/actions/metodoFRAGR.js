    ...
    $.getJSON("/FRAGR", function (result) {
        $.each(result, function (i, field) {
            tbl +=
                ...
                '<button type="submit" class="btn btn-link btn-info edit" onclick="validaImprimir(' + field.fragr001Id + ')"><i class="fa fa-print"></i></button>' +
                '<button type="submit" class="btn btn-link btn-warning edit" onclick="validaModificar(' + field.fragr001Id + ')"><i class="fa fa-edit"></i></button>' +
                '<button type="submit" class="btn btn-link btn-danger remove" onclick="validaEliminar(' + field.fragr001Id + ')"><i class="fa fa-times"></i></a>' +
                '</td>' +
                '</tr>';
        });
        tbl += '</tbody>';
