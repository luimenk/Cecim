...
function vistaAgregar(valor){
    window.location = "/agregarFRAEAT/" + valor;
}
...
function terminar(valor){
    window.location = "/terminarFRAEAT/" + valor;
}
    ...
    $.getJSON("/FRAEAT/getAllBy/"+id, function (result) {
        $.each(result, function (i, field) {
            ...
            tbl +=
                ...
                '<td class="text-center"><button class="btn btn-success" onclick="verImagen(' + field.idFRAEATDATA + ')"><i class="fa fa-picture-o"></i>Ver Imagen</button></td>' +
...
function cargarTabla() {
    ...
    $.getJSON("/FRAEAT", function (result) {
        $.each(result, function (i, field) {
            ...
            tbl +=
                '<tr>' +
                '<td class="text-center">' + field.idFRAEAT + '</td>' +
                ...
                '<td class="text-center"><button class="btn btn-info" onclick="verInfo(' + field.idFRAEAT + ')"><i class="fa fa-eye"></i>Ver</button></td>';
            if (field.estatus === "inicio"){
                tbl +=
                ...
                tbl +=
                    '<td class="text-center"><button class="btn btn-success" disabled><i class="fa fa-flag"></i>Iniciar</button></td>' +
                    '<td class="text-center"><button class="btn btn-warning" onclick="vistaAgregar(' + field.idFRAEAT + ')"><i class="fa fa-plus"></i>Agregar</button></td>' +
                    '<td class="text-center"><button class="btn btn-danger" onclick="terminar(' + field.idFRAEAT + ')"><i class="fa fa-save"></i>Terminar</button></td>';
            }
        });
        tbl += '</tbody>';
        tbl += '<tfoot>' +
