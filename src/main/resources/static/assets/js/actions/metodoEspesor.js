...
function validaImprimir(valor){
    window.location = "/determinacionEspesor/imprimirDeterminacionEspesores/" + valor;
}
...
function cargarTabla() {
    var tbl =
        ...
        '</tfoot>' +
        '<tbody>';
    $.getJSON("/determinacionEspesor", function (result) {
        $.each(result, function (i, field) {
            tbl +=
                ...
                '<button type="submit" class="btn btn-link btn-info edit" onclick="validaImprimir(' + field.determinacionEspesorId + ')"><i class="fa fa-print"></i></button>' +
                '<button type="submit" class="btn btn-link btn-warning edit" onclick="validaModificar(' + field.determinacionEspesorId + ')"><i class="fa fa-edit"></i></button>' +
                '<button type="submit" class="btn btn-link btn-danger remove" onclick="validaEliminar(' + field.determinacionEspesorId + ')"><i class="fa fa-times"></i></a>' +
                '</td>' +
                '</tr>';
        });
        tbl += '</tbody>';
