...
function validaImprimir(valor){
    window.location = "/espectrometriaInfrarroja/imprimirEspectrometriaInfrarroja/" + valor;
}
...
function cargarTabla() {
    var tbl =
        ...
        '</tfoot>' +
        '<tbody>';
    $.getJSON("/espectrometriaInfrarroja", function (result) {
        $.each(result, function (i, field) {
            tbl +=
                ...
                '<button type="submit" class="btn btn-link btn-info edit" onclick="validaImprimir(' + field.compuestosEspectrometriaInfrarrojaId + ')"><i class="fa fa-print"></i></button>' +
                '<button type="submit" class="btn btn-link btn-warning edit" onclick="validaModificar(' + field.compuestosEspectrometriaInfrarrojaId + ')"><i class="fa fa-edit"></i></button>' +
                '<button type="submit" class="btn btn-link btn-danger remove" onclick="validaEliminar(' + field.compuestosEspectrometriaInfrarrojaId + ')"><i class="fa fa-times"></i></a>' +
                '</td>' +
                '</tr>';
        });
        tbl += '</tbody>';
        $("#espectrometriaInfrarrojaTable").append(tbl);
        $('#espectrometriaInfrarrojaTable').DataTable({
