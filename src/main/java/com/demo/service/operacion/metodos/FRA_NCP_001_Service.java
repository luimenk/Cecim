...
public class FRA_NCP_001_Service {
    ...
    public ResponseEntity<InputStreamResource> crearFormato(Long id, int band) throws InvalidFormatException, IOException{
        ...
        table0.getRow(0).getCell(3).setText(formatoFechas.formateadorFechas(fra_ncp_001.getFechaInicioAnalisis()));
        table0.getRow(1).getCell(1).setText(fra_ncp_001.getIdInternoMuestra());
        table0.getRow(1).getCell(3).setText(formatoFechas.formateadorFechas(fra_ncp_001.getFechaFinalAnalisis()));
